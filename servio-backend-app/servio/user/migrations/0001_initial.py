    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competency', models.CharField(max_length=255, verbose_name='competency')),
                ('badge', models.CharField(default='Fasulye', max_length=255, verbose_name='badge')),
                ('credits', models.IntegerField(default=5, verbose_name='credits')),
                ('profilePic', models.CharField(max_length=255, verbose_name='profile picture')),
